  ...
  <div class="about">
    ...
    <template>
      <el-table :data="allTableData.slice((state.page-1)*state.limit, state.page*state.limit)"
        ...
        <el-table-column prop="userName" label="姓名" width="350" align="center"/>
        <el-table-column prop="passWord" label="密码" width="200" align="center"/>
        <el-table-column prop="phone" label="电话号码" width="250" align="center"/>
        <el-table-column prop="address" label="地址" width="350" align="center"/>
        <el-table-column prop="Operate" label="操作" align="center">
          <template v-slot="ope">
            <el-button @click="editUser(ope.row, ope.column, ope.$index)" getSelectionRows type="primary" circle
                       style="width: 30px;height: 30px;padding: 0" :disabled="isEditing" icon="el-icon-edit">
            </el-button>&emsp;
            <el-button type="danger" @click="deletePost(ope.row, ope.column, ope.$index)" circle
                       style="width: 30px;height: 30px;padding: 0" :disabled="isEditing" icon="el-icon-delete-solid">
            </el-button>
          </template>
        </el-table-column>
      </el-table>
    ...
    <el-dialog
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click="editPostUpdate">确认</el-button>
      </div>
    </el-dialog>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    doubleClick(row, column, cell, event) {
      ...
      // 设置输入框样式（蓝色边框）
      cellInput.style.cssText = `width: 80%;
                                 text-align: center;
